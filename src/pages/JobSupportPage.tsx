  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO
        ...
        description="Expert Online Job Support from India for AWS, Salesforce, Informatica, DevOps, Data Science, Java, PHP, Cyber Security & more. Real-time, confidential, and tailored to your live project needs."
